...
export default function AgentsPage() {
  ...
  return (
    <div className="min-h-screen bg-white">
      ...
      {/* 顶部导航 */}
      <header className="nav-bar relative z-10">
        <div className="max-w-7xl mx-auto px-6 py-3 flex items-center justify-between">
          <div className="flex items-center gap-4">
            <Link href="/" className="nav-link">
              ← 返回首页
            </Link>
            <span className="w-px h-4 bg-[#0f0f0f]" />
          ...
          <div className="flex items-center gap-3">
            ...
            <span className="badge-pixel">
              ...
              {customAgents.length > 0 && (
                <span className="ml-1 text-muted">({customAgents.length} 自定义)</span>
              )}
            </span>
          </div>
        </div>
            ...
            {categories.map((cat) => {
              ...
              return (
                ...
                >
                  {meta ? (
                    <>
                      <span className="w-2 h-2" style={{ backgroundColor: meta.color }} />
                      {meta.label}
                    </>
                  ) : (
                    cat
          ...
          {filtered.length === 0 ? (
            ...
            filtered.map((agent, idx) => {
              ...
              return (
                ...
                >
                  <div className="pixel-area pixel-area-hover overflow-hidden">
                    {/* 卡片头部 */}
                    <div
                    ...
                    >
                      {/* 精灵图 */}
                      <div className="flex-shrink-0 w-20 flex items-center justify-center bg-[#fafafa] border-r-2 border-[#0f0f0f] p-3">
                      ...
                      <div className="flex-1 min-w-0 px-5 py-4 flex flex-col justify-center">
                        <div className="flex items-center gap-2 mb-1">
                          ...
                          {agent.isCreator && (
                            <span className="badge-pixel text-[10px]">CREATOR</span>
                          )}
                          {agent.isCustom && (
                            <span className="badge-pixel text-[10px]" style={{ borderColor: "#8B5CF6", color: "#8B5CF6" }}>
                              自定义
                            </span>
                          )}
                          {personality && (
                      ...
                      {/* 右侧箭头 */}
                      <div className="flex-shrink-0 w-10 flex items-center justify-center text-muted">
                        <svg
                    ...
                    <AnimatePresence>
                      {isExpanded && personality && (
                        ...
                        >
                          <div className="border-t-2 border-[#0f0f0f] p-6 bg-white">
                            <div className="flex flex-col md:flex-row gap-6">
                              {/* 雷达图 */}
                              <div className="flex-shrink-0 flex flex-col items-center">
                                <div className="pixel-area p-3">
                              ...
                              <div className="flex-1 space-y-4">
                                ...
                                <div className="flex flex-wrap items-center gap-4">
                                  <div className="badge-pixel flex items-center gap-2 px-3 py-1.5">
                                ...
                                {synergyPartner && (
                                  <div className="pixel-area p-3">
                                    ...
                                    <span className="pixel-text text-[10px] font-medium ml-2">最佳搭档</span>
                                    <span className="pixel-text text-[11px] text-ink/70 ml-2">{synergyPartner}</span>
          ...
          <div className="flex flex-wrap gap-3 pt-4">
            {categories.filter((c) => c !== "all").map((cat) => {
              ...
              return (
                <div
                  key={cat}
                  className="badge-pixel flex items-center gap-2 cursor-pointer hover:bg-[#f3f3f3] transition-colors"
                  onClick={() => setSelectedCategory(cat)}
                >
                  <span
                    className="w-2 h-2"
